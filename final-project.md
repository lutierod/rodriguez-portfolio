...
**User story:** As an arts manager, I want to find an effective way to continue operations during the pandemic so that my organization can engage the largest part of the community.

**Call to action:** I can do this by innovating new remote opportunities that do not involve the internet, such as distributing packets, radio broadcasts, etc.
...
# Method and medium
I will complete my final project by creating a story using Shorthand. I will use both text and charts generated by Flourish and Tableau to convey my message. 
